...
\begin{figure}[H]
  \begin{center}
    ...
    \caption{Default and Combo settings on Mark Dataset; third epoch}
  \end{center}
\end{figure}
...
\begin{figure}[H]
  \begin{center}
    ...
    \caption{Default and Combo settings on Mark Dataset; training, validation, and test}
  \end{center}
\end{figure}
...
\begin{figure}[H]
  \begin{center}
    ...
    \caption{Default and Combo settings on Trump Dataset; third epoch}
  \end{center}
\end{figure}
...
\begin{figure}[H]
  \begin{center}
    ...
    \caption{Default and Combo settings on Trump Dataset; training, validation, and test}
  \end{center}
\end{figure}
