...
batch_size = 50  # minibatch size, i.e. size of data in each epoch
num_epochs = 100 # you should increase it if you want to see relatively good results
learning_rate = 0.002
decay_rate = 0.97
num_layers = 2 #number of layers in the RNN
## Values set from above
#rnn_size = hidden_units # size of RNN hidden state (output dimension)
...
class LSTMModel():
    def __init__(self,sample=False):
        rnn_size = 256 # size of RNN hidden state vector
        batch_size = 50 # minibatch size, i.e. size of dataset in each epoch
...
with tf.Session() as sess:
	...
	for e in range(num_epochs): # num_epochs is 125 for test, but should be higher
		...
		with tf.variable_scope("rnn", reuse=True):
			...
			print (sample_model.sample(sess, data_loader.chars , data_loader.vocab, num=100, prime='She ', sampling_type=1))
			print ('----------------------------------')
#END
