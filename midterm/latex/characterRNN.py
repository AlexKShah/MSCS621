...
class LSTMModel():
    def __init__(self,sample=False):
        rnn_size = hidden_units # size of RNN hidden state vector
...
with tf.Session() as sess:
	...
	for e in range(num_epochs): # num_epochs is 125 for test, but should be higher
		...
		with tf.variable_scope("rnn", reuse=True):
			...
			print (sample_model.sample(sess, data_loader.chars , data_loader.vocab, num=25, prime='The ', sampling_type=1))
			print ('-------------------')
#END
