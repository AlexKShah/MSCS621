...
# HW 3 instructions
#
# For the following experiments use "Our dataset" and leave 
# the pre-training epochs with 400 and the fine-tuning epochs with 50
#
# pt 1
# you will do two layers and will vary the number of neurons between
# 32, 64, 128, 256, 512, 1024; for a total of 15 experiments.
#
# pt 2
# Using the combination of neurons that gave you the best test accuracy, 
# vary the learning rate for each layer three times using different 
# combinations, you may use any learning rate between [0.1 and 0.00001]
